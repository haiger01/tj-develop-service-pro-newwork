...
public class Microfinance extends ParentEntity {
    ...
    public String addressCustomerNeeds;//解决客户需求
    public Long modeOfRepayment;    //还款方式：1-等额本息/2-等额本金/3-先息后本/4-一次性还 本付息/5-其它按月还 本付息/6-等本等息 /7-其他
    ...
    public Long getModeOfRepayment() {
        return modeOfRepayment;
    }

    public void setModeOfRepayment(Long modeOfRepayment) {
    ...
    public String getAddressCustomerNeeds() {
        return addressCustomerNeeds;
    }

    public void setAddressCustomerNeeds(String addressCustomerNeeds) {
        this.addressCustomerNeeds = addressCustomerNeeds;
    }
}
