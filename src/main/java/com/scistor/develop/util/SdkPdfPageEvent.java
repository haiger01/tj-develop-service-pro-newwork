...
public class SdkPdfPageEvent extends PdfPageEventHelper {
    ...
    public void onStartPage(PdfWriter writer, Document document) {
        // 水印(water mark)
         ...
         pcb.showTextAligned(Element.ALIGN_LEFT, "报告编号:20201020095624     查询机构:**银行       经办人：张**", 230, 135, 45);
         //pcb.showTextAligned(Element.ALIGN_LEFT, "报告编号:20201020095624     查询机构:**银行       经办人：张**", 300, 400, 45);
